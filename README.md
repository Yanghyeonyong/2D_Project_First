...
King Of Sky는 Unity 2D 기반의 로그라이크 액션 게임입니다. 플레이어는 여러 스테이지를 진행하며 적을 처치하고, 다양한 능력을 획득하며 성장하는 구조로 설계되어 있습니다. 게임은 상태 머신 기반의 플레이어 시스템, MVC 패턴의 적 시스템, 그리고 다양한 게임 메커니즘으로 구성되어 있습니다.
